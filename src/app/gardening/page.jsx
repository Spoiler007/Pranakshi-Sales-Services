...
<div className=' '>
            <div className="flex border-2 px-10 shadow-gray-200 rounded-bl-2xl rounded-br-2xl shadow-xl w-[85%] bg-gray-100 mx-auto gap-8  text-center items-center justify-between">
                <div className=' flex py-2'>
                    ...
                    <h1 className='text-center my-auto md:text-2xl mt-8 md:mt-14 font-semibold text-gray-500'> Sales & Services</h1>
                </div>
            ...
            <h1 className='mx-auto md:text-6xl text-3xl font-bold text-greenlight '>Gardening</h1>
                ...
                <img src='/Images/garden1.webp' alt='garden1' className='w-[70%] h-[50%] mx-auto' />
            </div>
            <div className='w-[70%] mx-auto gap-14 flex flex-col py-10'>
                <h1 className='w-[70%] text-center mx-auto text-xl font-semibold text-greendark'>Garden beautifies your home and is an excellent way to spend your time after work. If you’re new to gardening, start building your garden with these easy to follow steps:</h1>
                <div className='flex flex-col gap-3'>
                    <h1 className='text-2xl font-bold font-mono'>1.Pick the right spot</h1>
                    <p className='text-xl'>It is always better to take small steps towards big wins. Pick a small space to start building your garden.
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>Once you identify the right spot for your garden, the next step in your journey to gardening is choosing what type of garden you want.
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>Plants always benefit from the nutrient-rich gardening soil. Take your first step by examining the texture of your soil, it should be easily shovelled and crumble in your hands.
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>   Once you have a plan in place, you’ll need some basic gardening tools to get started. We’re listing a handful of tools required for gardening.</p>
                    <div className='flex gap-10 xl:flex-row flex-col-reverse '>
                    <p className='text-xl'>
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>Now comes the most exciting part of the gardening process - picking your greens. Before you rush to a conclusion on what to grow in your garden, take some time to study the plants.
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>Before getting your hands dirty and starting to plant your greens, plan it out!
<br/>
...
<br/>
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>Once you’re done with the planning, decide on the type and the size of the garden beds. Raised beds are attractive to look at and raised beds make it easier for you to work in your garden.
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>Once you’re done with the groundwork, you need to jump in and start planting. Most of our seed packets come with basic planting instructions. Give it a try and you’ll master the art of planting as you go.
                        <br /><br />
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <div className='flex gap-10 xl:flex-row flex-col '>
                    <p className='text-xl'>The goal of watering your plants is to give them enough water to sustain but overwatering your plants can lead to waterlogging which can damage your plants.
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-xl'>There's an old saying, “The fertilizer is the gardener's best friend.” Make your own organic fertilizer to give your plants the extra boost to grow.
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <div className='flex gap-10 xl:flex-row flex-col '>
                    <p className='text-xl'>Pests and diseases are more attracted to plants that are stressed or have some deficiency. If you have healthy, well-nourished plants, your pest and disease problems should be lesser. If your plants get infected, chances are there's an organic solution.
