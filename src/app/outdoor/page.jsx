...
const Outdoor = () => {
    return (
        <div>
            ...
            <StickyChat />
            <Stickysocial />
            <div className="flex bg-gradient-to-b from-greenlight to-greendark border-2 px-10 shadow-gray-200 rounded-bl-2xl rounded-br-2xl shadow-xl w-[85%]  mx-auto gap-8  text-center items-center justify-between">
