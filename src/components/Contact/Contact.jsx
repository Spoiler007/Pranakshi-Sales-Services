...
const Contact = () => {
    ...
    return (
        <div id="contact" className="grid grid-cols-1  gap-10 py-10 w-[85%] mx-auto sm:grid-cols-2 xl:grid-cols-4">
            <div className="shadow-2xl shadow-gray-500 rounded-xl px-3  flex flex-col gap-12  bg-gradient-to-b from-[#004e92] to-[#000428] xm:w-[350px] w-[250px] mx-auto">
                <div className='grid grid-cols-1 mx-auto text-center  items-center'>
                    ...
                    <h1 className='text-xl text-greenlight font-semibold'>Pranakshi Sales & Services</h1>
                </div>
                <p className="w-[80%] mx-auto pb-10 text-white tracking-wider text-md font-semibold "> <span className="text-yellowlight">Pranakshi Sales & Services </span>is a leading sales and service company specializing in premium plants. We provide tailored solutions, from expert plant sales to comprehensive maintenance services. Our team is committed to creating thriving green environments, whether for homes, offices, or commercial spaces. Experience excellence in plant care with Pranakshi Sales & Services .</p>
            </div>
            ...
            <div className="flex flex-col text-center  items-center">
                <div className="flex flex-col gap-5">
                    <h2 className="text-xl text-[gray] font-semibold underline underline-offset-2">Rate Our services </h2>
                ...
                <div className="flex flex-col gap-8 mt-10">
                    ...
                    <div className="flex flex-col gap-5 justify-center items-center">
                        <a href="#hero" id="hero" className="flex items-center gap-2"><IoLogoYoutube className="text-[#FF0000] text-2xl" /><span className="text-gray-500 font-semibold">You tube</span></a>
                        <a href="#hero" id="hero" className="flex items-center gap-2"><ImFacebook2 className="text-[blue] text-xl" /><span className="text-gray-500 font-semibold">Facebook</span></a>
                        <a href="#hero" id="hero" className="flex items-center gap-2"><TfiInstagram className="text-2xl text-greendark" /><span className="text-gray-500 font-semibold">Instagram</span></a>
            ...
            <div className="flex flex-col items-center">
                ...
                <form className="flex pt-10 pb-14 flex-col border gap-8 rounded-xl mt-5 px-5 bg-gradient-to-b from-[#004e92] to-[#040b4f]">
