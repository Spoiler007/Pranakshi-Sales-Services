...
const Stickysocial = () => {
  return (
    <div className=' md:-ml-[2%] -ml-[4%] z-20 fixed mt-[200px] flex w-fit rounded-tr-xl rounded-br-xl shadow-2xl xl:hidden bg-green-400 pr-1'>
         <div className="flex  gap-8 py-3">
                    {/* <h1 className="text-xl  text-yellowlight font-semibold underline underline-offset-2">Follow</h1> */}
                    <div className="flex flex-col pl-7 gap-5 justify-center items-center pb-2">
