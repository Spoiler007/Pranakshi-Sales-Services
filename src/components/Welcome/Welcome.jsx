...
const Welcome = () => {
    return (
        <div className='flex flex-col mt-24' id='home'>
                <img src='/Images/welcome.png' alt='welcome' className='max-w-[300px] mx-auto'/>
            <div className='flex flex-col text-center w-[70%] py-5 mx-auto  gap-3'>
                ...
                <section className='flex flex-col xm:flex-row mx-auto gap-5'>
                    <p className='text-xl font-mono'>to</p>
                    <h1 className='text-5xl font-bold font-mono bg-gradient-to-t from-greenlight to-yellowlight inline-block text-transparent bg-clip-text'> Pranakshi Sales & Services</h1></section>
                <h1 className='text-xl font-outfit'> - your premier destination for plant sales and services.</h1>
                ...
                <img src='/Images/home2.png' alt='home'className=''/>
